...
/**
 * Reduct inspection for <strong>Tolerance Class Positive Region Incremental (TCPR, static)</strong>.
 * This procedure contains 2 {@link ProcedureContainer}s:
 * <ul>
 * 	<li>
 ...
 * </ul>
 *
 * @see ToleranceClassPositiveRegionAlgorithm#inspection(Collection, Collection, int,
...
//						if (logOn)	log.info(LoggerUtil.spaceFormat(1, "1/{}. {}"), getComponents().size(), component.getDescription());
						...
						if (globalPos==null) {
							globalPos = 
								calculation.calculate(
									combinedTolerancesByAttributes.getTolerancesOfCombined().entrySet()
								).getResult();
							TimerUtils.timePause((TimeCounted) component);
							getParameters().setNonRoot("globalPos", globalPos);
			...
			new TimeCountedProcedureComponent<Object[]>(
					...
					false, (component, parameters) -> {
						...
						if (calculation.value1IsBetter(globalPos, pos, 0)) {
							reduct.add(attr);
