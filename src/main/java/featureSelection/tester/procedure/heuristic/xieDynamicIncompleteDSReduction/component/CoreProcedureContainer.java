...
/**
 * Core searching for <strong>Xie Dynamic In-complete Decision System Reduction(DIDS)</strong> Feature 
		...
		return new ProcedureComponent<?>[] {
			...
			new TimeCountedProcedureComponent<Collection<Integer>>(
					...
					false, (component, parameters) -> {
						...
						TimerUtils.timePause((TimeCounted) component);
						localParameters.put("examing", examing);
						TimerUtils.timeContinue((TimeCounted) component);
					...
					(component, result) -> {
						...
						if (logOn){
							log.info(LoggerUtil.spaceFormat(1, "core={}"),
