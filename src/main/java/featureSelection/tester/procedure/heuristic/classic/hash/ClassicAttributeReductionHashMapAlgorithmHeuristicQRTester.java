...
import featureSelection.tester.procedure.heuristic.classic.hash.procedure.CoreProcedureContainer;
import featureSelection.tester.procedure.heuristic.classic.hash.procedure.ReductInspectionProcedureContainer;
import featureSelection.tester.procedure.heuristic.classic.hash.procedure.SignificantAttributeSeekingLoopProcedureContainer;
...
public class ClassicAttributeReductionHashMapAlgorithmHeuristicQRTester<Sig extends Number>
				...
				QuickReductHeuristicReductStrategy
{
	...
	public ClassicAttributeReductionHashMapAlgorithmHeuristicQRTester(
		...
		return new ProcedureComponent<?>[] {
			...
			new TimeCountedProcedureComponent<Object[]>(
					...
					(component, parameters) -> {
						...
						Class<? extends ClassicHashMapCalculation<Sig>> calculationClass =
								(Class<? extends ClassicHashMapCalculation<Sig>>)
								parameters[p++];
						/* ------------------------------------------------------------------------------ */
						ClassicHashMapCalculation<Sig> calculation = calculationClass.newInstance();
						/* ------------------------------------------------------------------------------ */
					...
					(component, result) -> {
						/* ------------------------------------------------------------------------------ */
						int r=0;
						Map<Integer, Collection<Instance>> decClasses = (Map<Integer, Collection<Instance>>) result[r++];
						ClassicHashMapCalculation<Sig> calculation = (ClassicHashMapCalculation<Sig>) result[r++];
						/* ------------------------------------------------------------------------------ */
