...
/**
 * Significant attribute seeking loops for <strong>Incremental Dependency Calculation (IDC)</strong>
 ...
 * 	</li>
 * 	<li>
 * 	<strong>Check if <code>dep(red)==dep(C)</code>, if does, break : true-continue, false-break.</strong>
 * 		<p>Check if current reduct dependency equals to global dependency. If it is, finished
 * 	    	searching and break the loop. Otherwise, continue to seek.
 * 	</li>
 * 	<li>
 * 		<strong>Seek significant attribute</strong>
 * 		<p>Loop over attributes outside current reduct and seek for the most significant attribute
 * 	    	that has the max. outer significance.
 * 	</li>
 * 	<li>
 ...
 * 
 * @see IncrementalDependencyCalculationAlgorithm#mostSignificantAttribute(
 *      FeatureImportance4IncrementalDependencyCalculation, Number, Collection, Collection,
 *      Number, int[])
 * 
 * @author Benjamin_L
 */
				...
				ReportMapGenerated<String, Map<String, Object>>
{
	...
	public SignificantAttributeSeekingLoopProcedureContainer4IDC(
		...
		return new ProcedureComponent<?>[] {
			...
			new TimeCountedProcedureComponent<Sig>(
					...
					false, (component, parameters) -> {
						...
						/* ------------------------------------------------------------------------------ */
						return calculation.calculate(instances, new IntegerCollectionIterator(red))
											.getResult();
					}, 
