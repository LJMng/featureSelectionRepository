 ...
 * </ul>
 *
 * @see HeuristicDependencyCalculationAlgorithm#inspection(FeatureImportance4HeuristicDependencyCalculation,
 *      Number, Collection, int...)
 * @see HeuristicDependencyCalculationAlgorithm#inspection(FeatureImportance4HeuristicDependencyCalculation,
 *      Number, Collection, Collection)
 * @see HeuristicDependencyCalculationAlgorithm#inspection(FeatureImportance4HeuristicDependencyCalculation,
 *      Number, Collection, Collection, int...)
 * @see HeuristicDependencyCalculationAlgorithm#inspection(FeatureImportance4HeuristicDependencyCalculation,
 *      Number, Collection, Collection, Collection)
 * 
 * @author Benjamin_L
 */
@Slf4j
		...
		ReportMapGenerated<String, Map<String, Object>>
{
	...
	public ReductInspectionProcedureContainer4HDC(
		...
		return new ProcedureComponent<?>[] {
			...
			new TimeCountedProcedureComponent<Collection<Integer>>(
					...
					false, (component, parameters) -> {
						...
						/* ------------------------------------------------------------------------------ */
						// Loop over all attributes in reduct and check.
						Integer[] redCopy = reduct.toArray(new Integer[reduct.size()]);
						Sig globalDependency = calculation.calculate(instances, decisionValues, new IntegerCollectionIterator(reduct), parameters)
															.getResult();
			...
			new TimeCountedProcedureComponent<Object[]>(
					...
					false, (component, parameters) -> {
						...
						Sig examSig = calculation.calculate(instances, decisionValues, new IntegerCollectionIterator(reduct))
												.getResult();
