...
/**
 * Core calculation for <strong>Direct Dependency Calculation (DDC)</strong> Feature
 * Selection. This procedure contains 2 ProcedureComponents:
 * <ul>
 * 	<li>
 * 		<strong>Core procedure controller</strong>
 * 		<p>Control looping over attributes that are not in reduct, and calculate their
