...
/**
 * Core calculation for <strong>Incremental Dependency Calculation (IDC)</strong>
 ...
 * </ul>
 * 
 * @see IncrementalDependencyCalculationAlgorithm#core(FeatureImportance4IncrementalDependencyCalculation,
 *      Number, Collection, Number, int[])
 * 
 * @author Benjamin_L
 */
@Slf4j
		...
		return new ProcedureComponent<?>[] {
			...
			new TimeCountedProcedureComponent<Object[]>(
					...
					false, (component, parameters) -> {
						...
						// i.e. calculate dependency.
						Sig subDependency = calculation.calculate(instances, new IntegerArrayIterator(examAttributes))
														.getResult();
