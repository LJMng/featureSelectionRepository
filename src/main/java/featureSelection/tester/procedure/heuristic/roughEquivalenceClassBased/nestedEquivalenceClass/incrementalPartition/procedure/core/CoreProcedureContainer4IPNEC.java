 ...
 * Selection. This procedure contains 3 {@link ProcedureComponent}s:
 * <ul>
 * 	<li>
 ...
 * 	<li>
 * 		<strong>Core</strong>
 * 		<p>Loop over attributes (groups) in <code>coreAttributeProcessStrategy</code> to check
 * 	        every attribute.
 * 	</li>
 * 	<li>
 * 		<strong>Core loop</strong>
 * 		<p>Use IP-NEC core strategy to obtain core in bulk.
 * 	</li>
 * </ul>
 *
 ...
 */
@Slf4j
public class CoreProcedureContainer4IPNEC
				...
				ReportMapGenerated<String, Map<String, Object>>
{
	...
	public CoreProcedureContainer4IPNEC(ProcedureParameters parameters, boolean logOn) {
	...
	public String shortName() {
		return "Core(IP-NEC.tailor-made)";
	}
		...
		return new ProcedureComponent<?>[] {
			...
			new ProcedureComponent<Collection<Integer>>(
					...
					(component, parameters) -> {
						/* ------------------------------------------------------------------------------ */
						getComponents().get(1).exec();
						return (Collection<Integer>) localParameters.get("core");
					}, 
					(component, core) -> {
						/* ------------------------------------------------------------------------------ */
						if (logOn)	log.info(LoggerUtil.spaceFormat(1, "|Core| : {}"), core.size());
						/* ------------------------------------------------------------------------------ */
						// Statistics
						//	[STATISTIC_CORE_LIST]
					...
					@Override public String staticsName() {
						return shortName()+" | *. of "+getComponents().size()+"."+" "+getDescription();
					}
			...
			new TimeCountedProcedureComponent<Object[]>(
					...
					(component, result) -> {
						...
						Collection<Integer> examSizeRecords = statistics.get(StatisticsConstants.Procedure.STATISTIC_CORE_ATTRIBUTE_EXAMED_LENGTH);
