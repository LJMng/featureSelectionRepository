package featureSelection.tester.procedure.opt.genetic.procedure.roughEquivalenceClassBased.netsedEquivalenceClassBased.common.singleSolutionSelection;
...
/**
 * <strong>Genetic Algorithm</strong> Final single solution selection. Mainly, this contains only 1  
			...
			new TimeCountedProcedureComponent<int[]>(
					...
					false, (component, parameters) -> {
						...
						if (newReducts.keySet().size()==1) {
							return newReducts.keySet().iterator().next().key();
						}else {
