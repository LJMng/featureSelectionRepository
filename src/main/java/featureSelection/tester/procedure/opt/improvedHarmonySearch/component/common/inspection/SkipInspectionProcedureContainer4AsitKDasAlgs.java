 ...
 * contains only 1 ProcedureComponent: 
 * <ul>
 * 	<li>
 ...
 */
@Slf4j
public class SkipInspectionProcedureContainer4AsitKDasAlgs<Sig extends Number,
				...
				ReportMapGenerated<String, Map<String, Object>>
{
	...
	public SkipInspectionProcedureContainer4AsitKDasAlgs(ProcedureParameters parameters, boolean logOn) {
					...
					(component, parameters) -> {
						...
						if (geneRecord.getBestFitness()!=null) {
							...
							for (Harmony<?> harmony : geneRecord.getBestHarmonies()) {
								...
								redList = new HashSet<>(redList);
								for (int attr: previousReduct)	redList.add(attr);
								
								if (redList.size()!=redArray.length) {
									redArray = ArrayCollectionUtils.getIntArrayByCollection(redList);
