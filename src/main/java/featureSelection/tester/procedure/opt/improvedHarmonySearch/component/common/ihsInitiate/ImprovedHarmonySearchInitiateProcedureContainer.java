 ...
 */
@Slf4j
public class ImprovedHarmonySearchInitiateProcedureContainer<Cal extends FeatureImportance<Sig>,
															Sig extends Number, 
															CollectionItem,
				...
				ReportMapGenerated<String, Map<String, Object>>
{
	...
	public ImprovedHarmonySearchInitiateProcedureContainer(ProcedureParameters parameters, boolean logOn) {
						...
						if (params.getMaxFitness()==null) {
							params.setMaxFitness(
								(FValue) params.getRedAlg()
												.fitnessValue(calculation, instances, params.getAttributes())
							);
						}
						return new Object[] {
								calculation,
