package featureSelection.repository.support.calculation.dependency.dependencyCalculation.directDependencyCalculation;
				...
				FeatureImportance4DirectDependencyCalculation<Double>
{
	...
	private double dependency(Collection<Instance> instances, IntegerIterator attributes) {
	...
	public static class Support {
		/**
		 * Generate a {@link List} of {@link GridRecord} based on the given
		 * {@link Instance} {@link List}.
		 * 
		 * @param instances
		 ...
		 * @param key
		 * 		The key for searching in {@link GridRecord}.
		 * @param instance
		 * 		An {@link Instance}.
