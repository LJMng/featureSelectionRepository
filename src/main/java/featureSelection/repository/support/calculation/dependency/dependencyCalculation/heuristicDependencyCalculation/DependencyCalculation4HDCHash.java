				...
				FeatureImportance4HeuristicDependencyCalculation<Double>
{
	...
	private double dependency(Collection<Instance> universes, Collection<Integer> decisionValues,
		...
		return totalCRecords / (double) universes.size();
	}
	...
	public static int calculateConsistentRecords(
		...
		for (Instance xj : instances) {// if DecisionClass(xj)==dValue
